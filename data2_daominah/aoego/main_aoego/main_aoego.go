...
func main() {
	...
	//inputFilePath = `D:\game\age_of_empires_ror_hd\data2_daominah\Carthage_Camel.ai`
	...
	inputFilePath = `D:\game\age_of_empires_ror_hd\data2_daominah\Persia_Cavalry_Archer.ai`
